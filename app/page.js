...
export default function Page(){
 const[data,setData]=useState(null),[sel,setSel]=useState(''),[q,setQ]=useState(''),[file,setFile]=useState(''),[tab,setTab]=useState('dash'),[busy,setBusy]=useState(false),[reference,setReference]=useState(null),[eci,setEci]=useState(null),[blo,setBlo]=useState(null),[refFile,setRefFile]=useState(''),[eciFile,setEciFile]=useState(''),[bloFile,setBloFile]=useState(''),[sortKey,setSortKey]=useState('ps'),[sortDir,setSortDir]=useState('asc');
